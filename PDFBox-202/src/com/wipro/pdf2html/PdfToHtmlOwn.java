...
public class PdfToHtmlOwn {
	...
	public void generateHTMLWordDepth(File pdfFile, File outputHtml) {
	...
	public void generateHTMLLineDepth(File pdfFile, File outputHtml) {
			...
			for (SpatialPage spatialPage: spatialPages) {
				...
				for (SpatialArticle spatialArticle : articles) {
					...
					for (SpatialParagraph spatialParagraph : paragraphs) {
						...
						List<SpatialLine> spatialLines = spatialParagraph.getLines();
						for (SpatialLine spatialLine : spatialLines) {
							writer.write( tab + tab + tab + tab + tab + "<line style='left:" + (int)spatialLine.getXCord() + "pt;top:" + (int)spatialLine.getYCord()+ "pt;'>" + escapeMarkupCharacters(spatialLine.getText()) + "</line>\n");
						}
						writer.write( tab + tab + tab + tab + "</p>\n");
					}
					writer.write( tab + tab + tab + "</article>\n");
	...
	public void generateHTMLParaDepth(File pdfFile, File outputHtml) {
		...
		try {
			...
			for (SpatialPage spatialPage: spatialPages) {
				...
				for (SpatialArticle spatialArticle : articles) {
					...
					List<SpatialParagraph> paragraphs = spatialArticle.getParagraphs();
					for (SpatialParagraph spatialParagraph : paragraphs) {
						writer.write( tab + tab + tab + tab + "<p>" + escapeMarkupCharacters(spatialParagraph.getText()) +"</p>\n");
					}
					writer.write( tab + tab + tab + "</article>\n");
				}
				writer.write(tab + tab + "</page>\n");
